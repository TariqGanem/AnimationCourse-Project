...
void Renderer::set_snake_head()
{
	...
	Eigen::Vector3f top = scn->data_list[scn->snake_arms].getBoundings(0);
	Eigen::Vector3f up = scn->data_list[scn->snake_arms].getBoundings(0) - scn->data_list[scn->snake_arms].getBoundings(1);
